...
If you're picking an assembler for hand-writing, it's advisable to pick which has better macros (for you), instead of what has the best tooling integration. The reason is strictly because regardless of your tools, if you cannot reason properly, none of it matters, and macros help you to do so. They also help create the sense of indirection that functions in high-level languages provide. Thus reducing mental load. FASM for instance has great macros.
